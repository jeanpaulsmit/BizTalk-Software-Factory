...
namespace BizTalkSoftwareFactory.Actions
{
    ...
    /// </summary>
    class AddBizTalkProjectToSolution : Microsoft.Practices.RecipeFramework.Action
    {
        /// <summary>
        ...
        /// </summary>
        private string bizTalkApplicationName;

        /// <summary>
        /// Gets or sets the BizTalk application name.
        /// </summary>
        [Input(Required = true)]
        public string BizTalkApplicationName
        {
            get
            {
                return bizTalkApplicationName;
            }
            set
            {
                bizTalkApplicationName = value;
            }
        }
        ...
        public override void Execute()
        {
            ...
            // Set the BizTalk specific properties in the .user file
            Helper.SetProjectProperty(solution, vs.Solution.Projects.Item(vs.Solution.Projects.Count), "ApplicationName", BizTalkApplicationName, null, _PersistStorageType.PST_USER_FILE);
