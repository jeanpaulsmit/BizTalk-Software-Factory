  ...
  class CreateStrongNamedKey : Microsoft.Practices.RecipeFramework.Action
  {
    ...
    public override void Execute()
    {
      if (this.KeyFile == null)
      {
        ...
        RegistryKey regKeySN = Registry.LocalMachine.OpenSubKey(@"Software\Microsoft\Microsoft SDKs\Windows\v7.0A\WinSDK-NetFx40Tools");
        string sdkDir = regKeySN.GetValue(@"InstallationFolder").ToString();
