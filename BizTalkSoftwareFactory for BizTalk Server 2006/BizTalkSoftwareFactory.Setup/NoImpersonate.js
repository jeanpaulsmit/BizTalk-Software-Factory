...
// 01-23-08: add an entry to the Error table for the 1001 error code to avoid empty error dialogs on Vista
...
var view
var record
var sqlForErrorMessage
var viewForErrorMessage
...
try
{
	...
	sqlForErrorMessage = "INSERT INTO `Error` (`Error`, `Message`) VALUES (1001, 'Error [1]: [2]')";
	viewForErrorMessage = database.OpenView(sql);
	viewForErrorMessage.Execute();
	viewForErrorMessage.Close();
