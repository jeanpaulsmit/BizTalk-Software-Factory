...
{
    public class CopyFilesRecursivelyAction : ConfigurableAction
    {
        // Fields
        ...
        public override void Execute()
        {
            ...
            CopyDirRecursively(new DirectoryInfo(BusinessComponents.Helper.GetBSFTemplateLocation() + this.SourceDir), new DirectoryInfo(targetPath));
        }
