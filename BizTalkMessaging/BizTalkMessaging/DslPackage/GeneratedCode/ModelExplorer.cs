...
namespace BizTalkMessaging
{
	...
	/// </summary>
	internal partial class BizTalkMessagingExplorer : BizTalkMessagingExplorerBase
	{
		/// <summary>
		/// Constructs a new BizTalkMessagingExplorer.
		/// </summary>
		public BizTalkMessagingExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the BizTalkMessagingExplorerToolWindow.
	/// </summary>
	internal abstract class BizTalkMessagingExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new BizTalkMessagingExplorerBase.
		/// </summary>
		protected BizTalkMessagingExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.BizTalkMessagingExplorerMenu;
			}
		}
		...
		{
			get { return global::BizTalkMessaging.BizTalkMessagingModel.DomainClassId; }
		}
