...
namespace BizTalkMessaging
{
	...
	/// </summary>
	internal partial class BizTalkMessagingDocView : BizTalkMessagingDocViewBase
	{
		/// <summary>
		/// Constructs a new BizTalkMessagingDocView.
		/// </summary>
		public BizTalkMessagingDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class BizTalkMessagingDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new BizTalkMessagingDocView.
		/// </summary>
		protected BizTalkMessagingDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::BizTalkMessaging.BizTalkMessagingDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::BizTalkMessaging.BizTalkMessagingDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::BizTalkMessaging.BizTalkMessagingToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::BizTalkMessaging.BizTalkMessagingToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.BizTalkMessagingDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::BizTalkMessaging.BizTalkMessagingHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::BizTalkMessaging.BizTalkMessagingHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::BizTalkMessaging.BizTalkMessagingHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
