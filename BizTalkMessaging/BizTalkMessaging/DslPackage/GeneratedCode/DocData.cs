...
namespace BizTalkMessaging
{
	...
	/// </summary>
	internal partial class BizTalkMessagingDocData : BizTalkMessagingDocDataBase
	{
		/// <summary>
		/// Constructs a new BizTalkMessagingDocData.
		/// </summary>
		public BizTalkMessagingDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a BizTalkMessaging document in memory.
	/// </summary>
	internal abstract class BizTalkMessagingDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new BizTalkMessagingDocDataBase.
		/// </summary>
		protected BizTalkMessagingDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
                return global::BizTalkMessaging.BizTalkMessagingDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::BizTalkMessaging.BizTalkMessagingModel modelRoot = null;
			...
			global::BizTalkMessaging.BizTalkMessagingDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::BizTalkMessaging.BizTalkMessagingSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.Store, fileName, diagramFileName, schemaResolver, null /* no load-time validation */);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::BizTalkMessaging.BizTalkMessagingDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::BizTalkMessaging.BizTalkMessagingDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::BizTalkMessaging.BizTalkMessagingModel modelRoot = (global::BizTalkMessaging.BizTalkMessagingModel)this.RootElement;
			...
			{
				global::BizTalkMessaging.BizTalkMessagingDiagram diagram = diagrams[0] as global::BizTalkMessaging.BizTalkMessagingDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::BizTalkMessaging.BizTalkMessagingSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::BizTalkMessaging.BizTalkMessagingSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::BizTalkMessaging.BizTalkMessagingDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::BizTalkMessaging.BizTalkMessagingSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::BizTalkMessaging.BizTalkMessagingModel modelRoot = this.RootElement as global::BizTalkMessaging.BizTalkMessagingModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::BizTalkMessaging.BizTalkMessagingSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
