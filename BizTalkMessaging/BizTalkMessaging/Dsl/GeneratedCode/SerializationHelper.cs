...
{
	/// <summary>
	/// Partial class to handle serialization of BizTalkMessagingModel instance as a root-level XML element.
	/// </summary>
	public partial class BizTalkMessagingModelSerializer
	{
		/// <summary>
		/// Public ReadRootElement() method that deserializes a root-level BizTalkMessagingModel instance from XML.
		/// </summary>
				...
				if (schemaResolver != null)
				{
					...
					if (!string.IsNullOrEmpty(targetNamespace))
					{
						...
						if (schemas != null && schemas.Count > 0)
						{
							if (schemas.Count > 1)
							{
								BizTalkMessagingSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
							}
							...
							BizTalkMessagingSerializationBehaviorSchemaValidationCallback validationCallback = new BizTalkMessagingSerializationBehaviorSchemaValidationCallback(serializationContext);
						...
						{
							BizTalkMessagingSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
						}
					}
				}
		...
		private static void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						BizTalkMessagingSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					BizTalkMessagingSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		/// </summary>
		private sealed class BizTalkMessagingSerializationBehaviorSchemaValidationCallback
		{
			...
			internal BizTalkMessagingSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					BizTalkMessagingSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
	
		/// <summary>
		/// Public WriteRootElement() method that serializes a root-level BizTalkMessagingModel instance to XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">BizTalkMessagingModel instance that will be serialized.</param>
		...
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/BizTalkMessaging";
...
{
	/// <summary>
	/// Partial class to handle serialization of BizTalkMessagingDiagram instance as a root-level XML element.
	/// </summary>
	public partial class BizTalkMessagingDiagramSerializer
	{
		/// <summary>
		/// Public ReadRootElement() method that deserializes a root-level BizTalkMessagingDiagram instance from XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		...
		/// <summary>
		/// Public WriteRootElement() method that serializes a root-level BizTalkMessagingDiagram instance to XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">BizTalkMessagingDiagram instance that will be serialized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			#region Check Parameters
...
{
	/// <summary>
	/// Helper class for serializing and deserializing BizTalkMessaging models.
	/// </summary>
	public abstract partial class BizTalkMessagingSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected BizTalkMessagingSerializationHelperBase() { }
		#endregion
	
		/// <summary>
		/// Loads a BizTalkMessagingModel instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new BizTalkMessagingModel instance will be created into the default partition of this store.</param>
		/// <param name="fileName">Name of the file from which the BizTalkMessagingModel instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded BizTalkMessagingModel instance.</returns>
		public virtual BizTalkMessagingModel LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null) 
		...
		/// <summary>
		/// Loads a BizTalkMessagingModel instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded BizTalkMessagingModel instance.</returns>
		public virtual BizTalkMessagingModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a BizTalkMessagingModel instance.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="partition">Partition in which the new BizTalkMessagingModel instance will be created.</param>
		/// <param name="fileName">Name of the file from which the BizTalkMessagingModel instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		/// </param>
		/// <returns>The loaded BizTalkMessagingModel instance.</returns>
		public virtual BizTalkMessagingModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(BizTalkMessagingDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			BizTalkMessagingModel modelRoot = null;
			DslModeling::DomainClassXmlSerializer modelRootSerializer = this.Directory.GetSerializer(BizTalkMessagingModel.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for BizTalkMessagingModel!");
			if (modelRootSerializer != null)
			{
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true))
					{
						...
						// Set up MonikerResolver for BizTalkMessaging.
						...
						if (fileStream.Length > 5)
						{
							...
							try
							{
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as BizTalkMessagingModel;
									if (modelRoot != null && !serializationResult.Failed)
									{
										// Note: the actual instance we get back from TryCreateInstance() can be of a derived type of BizTalkMessagingModel,
		...
		/// <param name="modelRoot">BizTalkMessagingModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the BizTalkMessagingModel instance will be saved.</param>
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="modelRoot">BizTalkMessagingModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the BizTalkMessagingModel instance will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the BizTalkMessagingModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the BizTalkMessagingModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized BizTalkMessagingModel instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
		...
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">BizTalkMessagingDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the diagram.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized BizTalkMessagingDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
		...
		/// <summary>
		/// Helper method to create and initialize a new BizTalkMessagingModel.
		/// </summary>
		internal protected virtual BizTalkMessagingModel CreateModelHelper(DslModeling::Partition modelPartition)
		{
			BizTalkMessagingModel model = new BizTalkMessagingModel(modelPartition);
			return model;
		}
		
		/// <summary>
		/// Loads a BizTalkMessagingModel instance and its associated diagram file into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new BizTalkMessagingModel instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the BizTalkMessagingModel instance will be deserialized.</param>
		/// <param name="diagramFileName">Name of the file from which the BizTalkMessagingDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		/// </param>
		...
		/// </param>
		/// <returns>The loaded BizTalkMessagingModel instance.</returns>
		public virtual BizTalkMessagingModel LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
		...
		/// <summary>
		/// Loads a BizTalkMessagingModel instance and its associated diagram file into the default partition of the given store.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="store">The new BizTalkMessagingModel instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the BizTalkMessagingModel instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded BizTalkMessagingModel instance.</returns>
		public virtual BizTalkMessagingModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null)
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a BizTalkMessagingModel instance and its associated diagram file.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="modelPartition">Partition in which the new BizTalkMessagingModel instance will be created.</param>
		/// <param name="modelFileName">Name of the file from which the BizTalkMessagingModel instance will be deserialized.</param>
		/// <param name="diagramPartition">Partition in which the new BizTalkMessagingDiagram instance will be created.</param>
		/// <param name="diagramFileName">Name of the file from which the BizTalkMessagingDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual BizTalkMessagingModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			...
			BizTalkMessagingModel modelRoot;
			...
			BizTalkMessagingDiagram diagram = null;
			DslModeling::DomainClassXmlSerializer diagramSerializer = this.Directory.GetSerializer(BizTalkMessagingDiagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for BizTalkMessagingDiagram");
			if (diagramSerializer != null)
			{
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as BizTalkMessagingDiagram;
										if (diagram != null)
										{
											// Note: the actual instance we get back from TryCreateInstance() can be of a derived type of BizTalkMessagingDiagram,
											// so we need to find the correct serializer instance to deserialize the element properly.
		...
		/// <summary>
		/// Helper method to create and initialize a new BizTalkMessagingDiagram.
		/// </summary>
		...
		internal protected virtual BizTalkMessagingDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			BizTalkMessagingDiagram diagram = new BizTalkMessagingDiagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">BizTalkMessagingDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string modelFileName, BizTalkMessagingDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string modelFileName, BizTalkMessagingDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given BizTalkMessagingModel and BizTalkMessagingDiagram to the given files, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="modelRoot">BizTalkMessagingModel instance to be saved.</param>
		/// <param name="modelFileName">Name of the file in which the CanonicalSampleRoot instance will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingModel modelRoot, string modelFileName, BizTalkMessagingDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">BizTalkMessagingDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given BizTalkMessagingDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">BizTalkMessagingDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, BizTalkMessagingDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual string GetSerializedModelString(global::BizTalkMessaging.BizTalkMessagingModel modelRoot, global::System.Text.Encoding encoding)
		{
		...
		/// <summary>
		/// DomainXmlSerializerDirectory instance used by this BizTalkMessagingSerializationHelper class.
		/// </summary>
		...
		protected virtual DslModeling::DomainXmlSerializerDirectory Directory
		{
			...
			get
			{
				if (this.directory == null)
				{
					...
					directory.AddBehavior(BizTalkMessagingSerializationBehavior.Instance);
				}
		...
		internal protected virtual global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> GetMonikerResolvers(DslModeling::Store store)
		{
			...
			result.Add(BizTalkMessagingDomainModel.DomainModelId, new BizTalkMessagingSerializationBehaviorMonikerResolver(store, this.Directory));
			return result;
		}
	...
	/// Helper class for serializing and deserializing BizTalkMessaging models.
	/// </summary>
	public sealed partial class BizTalkMessagingSerializationHelper : BizTalkMessagingSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private BizTalkMessagingSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static BizTalkMessagingSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static BizTalkMessagingSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (BizTalkMessagingSerializationHelper.instance == null)
					BizTalkMessagingSerializationHelper.instance = new BizTalkMessagingSerializationHelper();
				return BizTalkMessagingSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace BizTalkMessaging
{
	...
	public partial class BizTalkMessagingModel
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = BizTalkMessagingSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									BizTalkMessagingDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
