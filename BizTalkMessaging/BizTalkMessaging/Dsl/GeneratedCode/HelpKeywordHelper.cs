...
namespace BizTalkMessaging
{
	...
	/// </remarks>
	public partial class BizTalkMessagingHelpKeywordHelper : BizTalkMessagingHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new BizTalkMessagingHelpKeywordHelper.
		/// </summary>
		protected BizTalkMessagingHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the BizTalkMessagingHelpKeywordHelper.
		/// </summary>
		public static BizTalkMessagingHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class BizTalkMessagingHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new BizTalkMessagingHelpKeywordHelperBase.
		/// </summary>
		protected BizTalkMessagingHelpKeywordHelperBase()
			: base() { }
