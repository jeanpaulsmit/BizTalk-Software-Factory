  ...
  class CreateStrongNamedKey : Microsoft.Practices.RecipeFramework.Action
  {
    ...
    public override void Execute()
    {
      if (this.KeyFile == null)
      {
        ...
        RegistryKey regKeySN = Registry.LocalMachine.OpenSubKey(@"Software\Microsoft\Microsoft SDKs\Windows\v8.0A");
        string sdkDir = regKeySN.GetValue(@"InstallationFolder").ToString() + @"Bin\NETFX 4.0 Tools\";
