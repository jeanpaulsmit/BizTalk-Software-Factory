...
namespace BizTalkSoftwareFactory.CustomWizardPages.PipelineComponentWizard
{
    public class PageGeneralProperties : CustomWizardPage
    {
        ...
        {
            return (Regex.IsMatch(txtComponentVersion.Text, ComponentVersionRegEx) && Regex.IsMatch(txtComponentName.Text, ComponentNameRegEx) && txtComponentDescription.Text.Length > 0);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.txtComponentDescription.Validating += new System.ComponentModel.CancelEventHandler(this.txtComponentDescription_Validating);
            // 
            // ErrProv
            // 
        ...
        private void txtComponentName_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                ErrProv.SetError(txtComponentName, "ComponentName can only contain alpha numeric characters and cannot start with a number");
            }
            else
            {
        ...
        private void txtComponentDescription_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (txtComponentDescription.Text.Length == 0)
            {
                ErrProv.SetError(txtComponentDescription, "ComponentDescription must contain a value");
            }
            else
            {
                ErrProv.SetError(txtComponentDescription, "Fill in some description");
            }
        }
